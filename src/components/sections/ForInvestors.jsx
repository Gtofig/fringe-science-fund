    ...
    const investmentPoints = [
        {
            ...
            description: 'Like venture capital, most projects may fail, but the ones that succeed could transform entire industries and civilizations.'
        },
        {
            icon: <FiUsers className="w-6 h-6 text-electric-blue" />,
            title: 'Connect with Visionaries',
            description: 'Join a network of forward-thinking investors and scientists working on the frontier of human knowledge.'
        },
        {
            icon: <FiShield className="w-6 h-6 text-electric-blue" />,
            title: 'Preserve Civilization',
            description: 'Help maintain our technological edge in the conflict between progress and regression.'
        },
        {
            icon: <FiAward className="w-6 h-6 text-electric-blue" />,
            title: 'Legacy Impact',
            description: 'Be remembered as an early supporter of breakthrough discoveries that changed human history.'
        }
    ];
        ...
        <section className="py-20 bg-gray-50 dark:bg-gray-900">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center mb-12">
                    ...
                    >
                        Join us in taking the same approach to fundamental science that venture capital
                        takes to startups: bold, high-risk, high-reward investments in ideas that could
                        change everything.
                    </motion.p>
                </div>
