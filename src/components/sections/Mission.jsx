  ...
  const features = [
    {
      ...
      description:
        'Just like venture capital for startups, we fund bold ideas that might fail but could change everything if they succeed.',
    },
    {
      icon: <FiTarget className="w-8 h-8 text-electric-blue" />,
      title: 'Beyond Orthodoxy',
      description:
        'We support research that challenges established paradigms and explores territory mainstream science has overlooked.',
    },
    {
      icon: <FiGlobe className="w-8 h-8 text-electric-blue" />,
      title: 'Advancing Civilization',
      description:
        'Progress depends on scientific breakthroughs. Without them, we risk stagnation and vulnerability to anti-civilization forces.',
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          >
            ...
            The engine of fundamental discovery has seized. To avoid a new dark age, we must
            rediscover and revitalize the &#34;fringe&#34; in science—funding the unorthodox ideas
