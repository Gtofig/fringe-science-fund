        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              Are you working on ideas that challenge established paradigms? Do mainstream funding
              sources reject your proposals for being too unconventional? The Fringe Science Fund
              was created for scientists like you.
            </p>
