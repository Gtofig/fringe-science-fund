    ...
    const procesSteps = [
        {
            ...
            description: 'Describe your idea, why it challenges current orthodoxy, and what revolutionary potential it holds.'
        },
        {
            icon: <FiUsers className="w-8 h-8 text-electric-blue" />,
            title: 'Initial Review',
            description: 'Our team of scientists and advisors will review your proposal for revolutionary potential.'
        },
        {
            icon: <FiClock className="w-8 h-8 text-electric-blue" />,
            title: 'Detailed Evaluation',
            description: 'Promising proposals undergo a deeper evaluation of feasibility and potential impact.'
        },
        {
            icon: <FiAward className="w-8 h-8 text-electric-blue" />,
            title: 'Funding Decision',
            description: 'Selected projects receive funding, mentorship, and access to our community of fringe scientists.'
        }
    ];
    ...
    const fundingAreas = [
        {
            ...
            description: 'Novel approaches to energy generation and storage that go beyond conventional methods.'
        },
        {
            title: 'Fundamental Physics',
            description: 'Explorations that challenge or extend our understanding of quantum mechanics, relativity, or other foundational theories.'
        },
        {
            title: 'Consciousness Studies',
            description: 'Research on the nature of consciousness that bridges physical and cognitive sciences.'
        },
        {
            title: 'Biological Enhancement',
            description: 'Novel approaches to extending human capabilities or lifespans outside of mainstream biomedical frameworks.'
        },
        {
            title: 'Computing Paradigms',
            description: 'Non-conventional approaches to computation, information processing, or artificial intelligence.'
        },
        {
            title: 'Other Breakthrough Areas',
            description: 'Any area with potential for paradigm-shifting discoveries not covered by conventional funding sources.'
        }
    ];
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 0.5, delay: 0.1 }}
                        >
                            Submit your proposal by completing our application form. We review applications on a rolling basis.
                        </motion.p>
                        ...
                        >
                            Questions? Email us at <a href="mailto:info@fringesciencefund.org" className="text-electric-blue hover:underline">info@fringesciencefund.org</a>
                        </motion.p>
                    </div>
                </div>
            </section>
