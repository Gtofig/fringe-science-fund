    ...
    const investmentModels = [
        {
            ...
            description: 'Make direct investments in specific fringe science projects that align with your interests and vision.',
            suitable: 'Individual investors interested in specific scientific areas'
        },
        {
            title: 'Fund Contributor',
            description: 'Contribute to our general fund that supports a portfolio of high-risk, high-potential projects.',
            suitable: 'Investors looking for diversification across multiple fringe science projects'
        },
        {
            title: 'Strategic Partner',
            description: 'Form a longer-term partnership to support specific research areas aligned with your strategic goals.',
            suitable: 'Organizations, corporations, and institutions with strategic interests in breakthrough science'
        },
        {
            title: 'Philanthropic Supporter',
            description: 'Make tax-deductible donations to advance civilization through scientific progress.',
    ...
    const impactAreas = [
        {
            ...
            description: 'Fund breakthroughs that could render current technologies obsolete, creating entirely new industries.'
        },
        {
            icon: <FiTrendingUp className="w-12 h-12 text-electric-blue" />,
            title: 'Return on Investment',
            description: 'While high-risk, the projects that succeed could generate extraordinary returns, similar to early-stage tech investments.'
        },
        {
            icon: <FiUsers className="w-12 h-12 text-electric-blue" />,
            title: 'Network Access',
            description: 'Join our community of forward-thinking investors and brilliant scientific minds working at the edge of discovery.'
        },
        {
            icon: <FiShield className="w-12 h-12 text-electric-blue" />,
            title: 'Civilizational Resilience',
            description: 'Help maintain our technological advantage in the larger conflict between progress and regression.'
        },
        {
            icon: <FiGlobe className="w-12 h-12 text-electric-blue" />,
            title: 'Legacy Impact',
            description: 'Be remembered as an early supporter of breakthroughs that fundamentally changed human history and capability.'
        }
    ];
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        >
                            <p className="text-gray-700 dark:text-gray-300 mb-6">
                                We take the same approach to fundamental science that venture capital takes to startups:
                                bold, high-risk, high-reward investments in ideas that could change everything.
                            </p>
                            ...
                            <p className="text-gray-700 dark:text-gray-300">
                                By funding projects that are too unconventional for traditional sources, we create the
                                possibility of breakthroughs that could transform entire industries and civilizations.
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 0.5, delay: 0.1 }}
                        >
                            Contact our investor relations team to discuss how you can be part of funding
                        ...
                        >
                            Prefer to email us directly? Contact our investor relations team at <a href="mailto:invest@fringesciencefund.org" className="text-electric-blue hover:underline">invest@fringesciencefund.org</a>
                        </motion.p>
                    </div>
                </div>
            </section>
