    ...
    const contactOptions = [
        {
            ...
            description: 'Questions about application process, research criteria, or funding opportunities',
            ...
            <section className="pt-24 pb-12 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-space-dark">
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            We&#39;d love to hear from you. Reach out with questions, ideas, or to discuss collaboration opportunities.
                        </motion.p>
                    </div>
                </div>
            </section>
